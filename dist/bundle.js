...
/***/ function(module, exports, __webpack_require__) {
	...
	var _OpenApi = __webpack_require__(4);
	...
	var OpenApi = function () {
	  ...
	  _createClass(OpenApi, [{
	    ...
	    value: function createUser(user) {
	      var path = "/api/v1/" + this.encodedTenantAlias + "/open/account/" + encodeURIComponent(user.accountId) + "/user/" + encodeURIComponent(user.id);
	      var url = this.domain + path;
	      return this.doPost(url, JSON.stringify(user));
	    }
	  }, {
	    key: "lookUpUser",
	    value: function lookUpUser(accountId, userId) {
	      var path = "/api/v1/" + this.encodedTenantAlias + "/open/account/" + encodeURIComponent(accountId) + "/user/" + encodeURIComponent(userId);
	      var url = this.domain + path;
	      return this.doRequest(url);
	    }
	  }, {
	    key: "getUserByReferralCode",
	    value: function getUserByReferralCode(referralCode) {
	      var path = "/api/v1/" + this.encodedTenantAlias + "/open/user?referralCode=" + encodeURIComponent(referralCode);
	      var url = this.domain + path;
	      return this.doRequest(url);
	    }
	  }, {
	    key: "lookUpReferralCode",
	    value: function lookUpReferralCode(referralCode) {
	      var path = "/api/v1/" + this.encodedTenantAlias + "/open/code/" + encodeURIComponent(referralCode);
	      var url = this.domain + path;
	      return this.doRequest(url);
	    }
	  }, {
	    key: "applyReferralCode",
	    value: function applyReferralCode(referralCode, accountId, userId) {
	      var path = "/api/v1/" + this.encodedTenantAlias + "/open/code/" + encodeURIComponent(referralCode) + "/account/" + encodeURIComponent(accountId) + "/user/" + encodeURIComponent(userId);
	      var url = this.domain + path;
	    ...
	    value: function listReferrals() {
	      var path = "/api/v1/" + this.encodedTenantAlias + "/open/referrals";
	      var url = this.domain + path;
	      return this.doRequest(url);
	    }
	  }, {
